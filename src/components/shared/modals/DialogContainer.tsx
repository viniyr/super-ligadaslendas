                    ...
                    <div className="flex min-h-full items-center justify-center p-1 lg:p-4 text-center">
                        ...
                        >
                            <HeadlessDialog.Panel
                                className="w-screen h-full md:w-fit lg:min-w-[600px] transform overflow-hidden rounded-lg bg-primary-color backdrop-blur-2xl bg-opacity-50 px-4 lg:px-6 py-12 lg:p-12 text-left align-middle shadow-2xl transition-all bg-gradient-139 from-black/25 to-transparent border-[1px] border-lol-red/50">
